# -*- coding: utf-8 -*-
# Create a program that reads any integer and displays its multiplication table up to 10

n = int(input('Enter the number for which you want to see the multiplication table up to 10: '))
